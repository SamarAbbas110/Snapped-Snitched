...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-semibold">
      ...
      <div className="flex items-center gap-5 px-0 px-414">
        {/* setshowsearch for getting the search bar when click on the search icon */}
        <img
        ...
        <div className="group relative">
          <img
            ...
            alt=""
          />
          {/* If the token is unavailable it means when the user was not logged to dont show the dropdown  */}
          {token && (
